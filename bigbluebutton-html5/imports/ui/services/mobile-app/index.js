...
(function () {
  ...
  if (browserInfo.isTabletApp) {
    ...
    prototype.setLocalDescription = function (description, successCallback, failureCallback) {
      ...
      Object.defineProperty(this, 'localDescription', { get() { return this._localDescription; }, set(newValue) {} });
    ...
    prototype.setRemoteDescription = function (description, successCallback, failureCallback) {
      ...
      Object.defineProperty(this, 'remoteDescription', { get() { return this._remoteDescription; }, set(newValue) {} });
      ...
      return new Promise((resolve, reject) => {
        callNativeMethod(setRemoteDescriptionMethod, [description]).then(() => {
          ...
          if (webRtcCallType === WEBRTC_CALL_TYPE_FULL_AUDIO) {
            Object.defineProperty(this, 'iceGatheringState', { get() { return 'complete'; }, set: () => {} });
            Object.defineProperty(this, 'iceConnectionState', { get() { return 'completed'; }, set: () => {} });
    ...
    const stopOriginal = KurentoScreenShareBridge.stop.bind(KurentoScreenShareBridge);
